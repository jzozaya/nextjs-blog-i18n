...
lastmod: '2024-08-01'
language: en
tags: ['tensorflow', 'movenet', 'pose-estimation', 'content-pipeline', 'shareable-content']
authors: ['jorgezozaya']
...
The act of dancing stimulates neuroplasticity, the brain's ability to reorganize itself by forming new neural connections throughout life, a critical function in an era where conformity and uniformity are often enforced. It demands coordination, rhythm, memory, and emotional expression, stimulating different areas of the brain simultaneously
...
[Watch the video](https://www.youtube.com/shorts/TxLP9RQPMJw)


<div className="-mx-2 flex flex-wrap overflow-hidden xl:-mx-2">
  <div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:w-1/2 xl:px-2">
    ![Maple](https://res.cloudinary.com/dbtnomqnj/image/upload/v1732918376/portfolio/Screenshot_2024-11-29_at_2.02.34_PM_uh1vpz.jpg)
  </div>
  <div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:w-1/2 xl:px-2">
...
<Audioplayer src="/static/images/Interactive Dance Tracker with MoveNet.wav" />
